...
class PaymentHelper
{
    ...
    */
    ...
    {        
        ...
        $payment->status          = (in_array($requestData['tid_status'], ['75', '85', '86', '90', '91', '98', '99']) ? Payment::STATUS_AWAITING_APPROVAL : ($requestData['type'] == 'cancel' ? Payment::STATUS_REFUSED : Payment::STATUS_CAPTURED));
